  ...
  if ( typeof value !== 'undefined') {
    ...
    if (document.cookie && document.cookie !== '') {
      ...
      for (var i = 0; i < cookies.length; i++) {
        var cookie = jQueryAnyplast.trim(cookies[i]);
...
jQueryAnyplast(function() {
  ...
  /* Show or hide themes panel
   ----------------------------------------------------------*/
  var
    themesPanel = jQueryAnyplast('#themes_panel'),
    themesPanelWidth = jQueryAnyplast('#themes_menu').outerWidth();
  ...
  jQueryAnyplast('#toggle_button').click(function() {
    closePanel();
    return false;
  });
  ...
  if ($.cookie('skin') !== null) {
    ...
    jQueryAnyplast('#primary_color_scheme').attr('href', 'styles/theme_' + $.cookie('skin') + '.css');
    updateLogoColor($.cookie('skin'));
  }
  if ($.cookie('layout') !== null) {
    ...
    if (value === 'boxed'){
      jQueryAnyplast('body').addClass('boxed-layout');
    } else {
      jQueryAnyplast('body').removeClass('boxed-layout');
    }
    jQueryAnyplast('#themes_panel .layout-switcher').val(value);
  ...
  /* Change Theme Colors on click and set cookie
   ----------------------------------------------------------*/
  jQueryAnyplast('#themes_panel ul.theme.cookie_colors li a').click(function() {
    var cSkin = jQueryAnyplast(this).attr('title');
    $.cookie('skin', cSkin, {
      expires : 0,
      path : '/'
    });
    jQueryAnyplast('#primary_color_scheme').attr('href', 'styles/theme_' + cSkin + '.css');
    updateLogoColor(cSkin);
    closePanel();
    return false;
  });
  ...
  /* Change layout style and set cookie
   ----------------------------------------------------------*/
  jQueryAnyplast('#themes_panel .layout-switcher').change(function() {
    ...
    var
        ...
        initMap = function(){
            if ($.fn.gMap !== undefined) {
                ...
                console.error('jQueryAnyplast.gMap not available!');
            }
        };
